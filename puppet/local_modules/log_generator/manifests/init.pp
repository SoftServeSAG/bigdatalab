class log_generator (
  ...
  $apache_access_flume_agent_host = hiera( 'profiles::log_generator::flume_agent_node', $::ipaddress ),
  ...
  $apache_error_flume_agent_host  = hiera( 'profiles::log_generator::flume_agent_node', $::ipaddress ),
